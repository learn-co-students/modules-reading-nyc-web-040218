...
class Dancer
  ...
  extend MetaDancing  #Allows us to use the MetaDancing module's CLASS methods, such as Dancer.metadata, but not instance methods. This means we require two seperate modules for full functionality. We are better off doing the following instead.
